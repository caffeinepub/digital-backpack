...
export class Backend implements backendInterface {
    ...
    async createItem(arg0: string, arg1: bigint, arg2: string, arg3: number): Promise<BackpackItem> {
        if (this.processError) {
            try {
                const result = await this.actor.createItem(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItem(arg0: bigint): Promise<BackpackItem> {
        if (this.processError) {
            try {
    ...
    async hasBackpack(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasBackpack();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeBackpack(): Promise<boolean | null> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeBackpack();
    ...
    async listItems(): Promise<Array<BackpackItem>> {
        if (this.processError) {
            try {
    ...
    async updateItem(arg0: bigint, arg1: string, arg2: bigint, arg3: string, arg4: number): Promise<void> {
        if (this.processError) {
            try {
